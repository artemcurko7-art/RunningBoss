...
public class QuestView : MonoBehaviour
{
    ...
    {
        _nameLocalization.Initialize(YG2.envir.language, quest.Config.NameRussian, quest.Config.NameEnglish, quest.Config.NameTurkish);
        _descriptionLocalization.Initialize(YG2.envir.language, quest.Config.DescriptionRussian, quest.Config.DescriptionEnglish, quest.Config.DescriptionTurkish);
