...
namespace Game.Scripts.MV.Progress
{
    public class ProgressView : MonoBehaviour
    {
        ...
        public void Initialize(Progress progress)
        {
            ...
            _nameLocalization.Initialize(YG2.envir.language, progress.Config.NameRussian, progress.Config.NameEnglish,
                progress.Config.NameTurkish);
            _descriptionLocalization.Initialize(YG2.envir.language, progress.Config.DescriptionRussian,
                progress.Config.DescriptionEnglish, progress.Config.DescriptionTurkish);
