...
namespace Game.Scripts.Inventory.ItemContext
{
    public class ItemCell : MonoBehaviour
    {
        ...
        public void Initialize(ItemType type, Sprite icon, string nameRussian, string nameEnglish, string nameTurkish,
            float fillAmount)
        {
            Type = type;
            _filling.sprite = icon;
            _empty.sprite = icon;
            _nameLocalization.Initialize(
                YG2.envir.language != YG2.saves.Language ? YG2.saves.Language : YG2.envir.language, nameRussian,
                nameEnglish, nameTurkish);
