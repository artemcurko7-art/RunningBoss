...
using Game.Scripts.Inventory.Storage;
...
namespace Game.Scripts.Inventory
{
    public class SelectorItemUpdater
    {
        ...
        public void Update(ItemType type, IAnimalData animalData, AnimalView animalView,
            InventoryService inventoryService, int oldIndex, out int index)
        {
            index = oldIndex;
