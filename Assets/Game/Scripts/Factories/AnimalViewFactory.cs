...
namespace Game.Scripts.Factories
{
    public class AnimalViewFactory
    {
        ...
        {
            var viewAnimal = _container.InstantiatePrefabForComponent<AnimalView>(_animalProvider.AnimalView,
        ...
        {
            var view = _container.InstantiatePrefabForComponent<AnimalView>(animalView, container.position,
                Quaternion.Euler(0, 134f, 0), container);
