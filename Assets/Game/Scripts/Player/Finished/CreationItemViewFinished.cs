...
namespace Game.Scripts.Player.Finished
{
    public class CreationItemViewFinished : FinishedSubscriber
    {
        ...
        public CreationItemViewFinished(IFinished finished, ItemData data, ItemViewService service,
            ItemCellFactory factory, IItemViewProvider provider, RectTransform container)
            : base(finished)
        {
            _data = data;
            _service = service;
