...
{
    public class SelectorAnimalViewService : ISelectorService, ISetterSelectorAnimalService, IAnimalSelected,
        IAnimalSelectedButton
    {
        ...
        public SelectorAnimalViewService(AnimalData data, AnimalProvider provider, AnimalViewFactory factory,
            Transform container)
        {
            _data = data;
            _provider = provider;
